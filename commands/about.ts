...
const embed = new EmbedBuilder()
  ...
  .setDescription(`Овој бот е развиен од <@198249751001563136> за потребите на Discord серверот на студентите на ФИНКИ. Ботот е open source и може да се најде на [GitHub](https://github.com/Delemangi/finki-discord-bot). Ако имате било какви прашања, предлози или проблеми, контактирајте не на Discord или на GitHub. \n\nНапишете ${inlineCode('/help')} за да ги видите сите достапни команди од ботот. Останатите функционалности се достапни на GitHub.`);
