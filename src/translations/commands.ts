...
export const commandDescriptions = {
  ...
  "members barred": "Превземи листа од забранети членови",
  "members count": "Прикажи број на членови на серверот",
  "members regulars": "Превземи листа од редовните членови",
  "members vip": "Превземи ги членовите на ВИП",
...
export const commandErrors = {
  ...
  barsFetchFailed: "Превземањето на забраните беше неуспешно.",
