...
export const commandDescriptions = {
  ...
  "config get": "Превземи конфигурација на ботот",
  "config set": "Измени конфигурација на ботот",
  ...
  "vip ban": "Предложи бан на член во ВИП",
  "vip bans": "Банирани членови на ВИП",
  ...
  "vip unban": "Предложи бришење на бан на член во ВИП",
